...
export function pickAgentForMessage(message: string, preferredAgent?: ChatAgentKey) {
  if (preferredAgent) {
...
export function getFallbackAssistantReply(message: string, preferredAgent?: ChatAgentKey) {
...
export function buildChatInstructions(topicNotes: string, agentKey: ChatAgentKey) {
