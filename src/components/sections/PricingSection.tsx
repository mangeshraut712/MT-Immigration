        ...
        <section id="pricing" className="section-padding bg-white relative overflow-hidden">
            ...
            <div className="container-wide relative z-10">
                <div className="grid lg:grid-cols-3 gap-16">
                    ...
                    >
                        <div className="lg:sticky lg:top-32 space-y-8">
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 mt-4 p-4 bg-zinc-50 border border-zinc-100 rounded-xl">
                            ...
                            <Button asChild size="lg" className="w-full rounded-xl bg-black text-white hover:bg-zinc-800 shadow-md h-12 text-base">
                    ...
                    >
                        <div className="bg-white rounded-3xl border border-zinc-100 shadow-sm hover:shadow-xl transition-shadow duration-500 overflow-hidden">
                            <Table>
                                <TableHeader>
